 ...
 * @returns {Array}
 */
export function findAll(string, mark) {
    var matches = [];
 ...
 */
export function computeLineEndings(string) {
    var endings = findAll(string, "\n");
 ...
 * @returns {*}
 */
export function lowerBound(array, object, comparator, left, right) {
 ...
 * @returns {*}
 */
export function peekLast(array) {
